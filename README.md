...
2. 要求 php版本 >= 7.3
3. 一键安装时通过修改配置文件，实现自定义服务端口、服务名、数据库、地址等信息
4. 当前项目为纯后端Api接口，小程序端用uniapp实现，查看源码，请跳转至：xxx 查看
5. 管理后台代码目前开发中，开发进度30%，预计2-3个月会完成并全部开源

#### 特点

1.  简化微服务的配置与调用过程，像开发单应用一样开发微服务系统！

2.  RPC服务--一键生成基于数据表，对外提供的增删改查rpc服务.

3.  路由服务--一键生成服务间的调用配置，让关注点聚焦业务.
