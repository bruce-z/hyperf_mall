...
services = [
    {
        ...
        'service_name': 'hypref_mall_goods',  # 服务名，默认与仓库名保持一致， 可自定义
        'ch_name': '商品服务',
    ...
    },
    {
        ...
        'service_name': 'hypref_mall_images',
        'ch_name': '图片服务',
        'port': 5504,
        'db_name': 'file_center',
    },
    {
        ...
        'service_name': 'hypref_mall_member',
        'ch_name': '会员服务',
        'port': 5505,
        'db_name': 'member',
    },
    {
        ...
        'service_name': 'hypref_mall_config',
        'ch_name': '配置服务',
        'port': 5506,
        'db_name': 'config',
    },
    {
        ...
        'service_name': 'hypref_mall_order',
        'ch_name': '订单服务',
        'port': 5507,
        'db_name': 'orders',
    },
    ...
    },
    {
        ...
        'service_name': 'hypref_mall_admin',
        'ch_name': '路由服务',
        'port': 5566,
        'db_name': False,
    },
...
mysql_service = {
    'images': "mysql:5.7.37",
    'service_name': 'hypref_mall_mysql',
    'port': 5567,
...
redis_service = {
    'images': "redis",
    'service_name': 'hypref_mall_redis',
    'port': 5568
}
